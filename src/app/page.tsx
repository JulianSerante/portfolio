    ...
    <Layout>
      <AnimatePresence mode="wait">
        <motion.div className="flex flex-col flex-grow px-6" key='about' variants={routeAnimation} initial='initial' animate='animate' exit='exit'>
          ...
          <motion.h5 className="text-lg text-justify hover:text-green-300 hover:transition" variants={fadeInUp} initial='initial' animate='animate'>
          ...
          <br />
          <motion.h5 className="text-xl italic font-bold tracking-wide text-justify hover:text-green-300 hover:transition" variants={fadeInUp} initial='initial' animate='animate'>
